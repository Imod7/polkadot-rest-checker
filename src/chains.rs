...
impl Chain {
    ...
    pub fn staking_test_accounts(&self) -> &'static [TestAccount] {
        match self {
            ...
            Chain::AssetHubPolkadot => ASSET_HUB_POLKADOT_STAKING_ACCOUNTS,
    ...
    pub fn has_staking_accounts(&self) -> bool {
        matches!(self, Chain::Polkadot | Chain::AssetHubPolkadot)
    }
...
pub const POLKADOT_TEST_ACCOUNTS: &[TestAccount] = &[
    TestAccount {
        address: "15Mba2pkKLEaSsfH5nkVWnHqB1cbkmVVghTJbqthKSw7RmMs",
        label: "Account 1",
    },
    TestAccount {
        address: "1HwQbUpcr99UA6W7WBK86RtMHJTBWRazpxuYfRHyhSCbE1j",
        label: "Account 2",
    },
    TestAccount {
        address: "13nEo1kDJduJSpNkXCYFWXVLBUc2waRwcFGeFbwXWM9iALA6",
        label: "Account 3",
    },
    TestAccount {
...
pub const KUSAMA_TEST_ACCOUNTS: &[TestAccount] = &[
    TestAccount {
        address: "HCRUhtREEbmuWufk154isxs2Nt2s2mBfjfQqYtdzRSyyii8",
        label: "Account 1",
    },
    TestAccount {
        address: "G88i4RL8Py5mHWeeB62qaiGS2CXJpmr7ToJbMZ4FMFJxRjG",
        label: "Account 2",
    },
    TestAccount {
    ...
    TestAccount {
        address: "GFLdqBZKfPfbpbVB8rAc8tqqWSKpKHskkGHPGAgQ4atRkJ7",
        label: "Account 4",
    },
];
...
pub const ASSET_HUB_POLKADOT_TEST_ACCOUNTS: &[TestAccount] = &[
    TestAccount {
        address: "19KT274PAdSchBjDmnxh6vEMdy4QFU9Bo6jgMZhen3esYGG",
        label: "Account 1",
    },
    TestAccount {
    ...
    TestAccount {
        address: "15sNh1RdsPQtrZ2w8THjGRYBjx2eAj2uWjfHiWiVvUJ6mzf2",
        label: "Account 3",
    },
    TestAccount {
        address: "13oSJ635GZos8UYrrcwXtp3XWC1G3XHrPvN6skMLdxzUr4sr",
        label: "Account 4",
    },
    TestAccount {
        address: "1kFzWWBHdkfajDqKAztSGL4vxNoDuazhm565JDwqUaJeuaH",
        label: "Account 5",
    },
    TestAccount {
        address: "1516GwEgo6PmwDtHprgqx9zyaELKWwx7KNiFXgQHwPuBnPAz",
        label: "Account 6",
    },
];

/// Staking stash accounts for Polkadot relay chain
pub const ASSET_HUB_POLKADOT_STAKING_ACCOUNTS: &[TestAccount] = &[
    TestAccount {
        address: "15uCAG6qK9qdx3EG3kyb5TFn83PgFUSQEioUgA9GLTjMFfq",
        label: "Stash 1",
    },
    TestAccount {
    ...
    TestAccount {
        address: "12Z6FSvMFRjno881i1qpFndrtZtcVCLs5v4nR92McQNX31CT",
        label: "Stash 4",
    },
    TestAccount {
...
pub const ASSET_HUB_KUSAMA_TEST_ACCOUNTS: &[TestAccount] = &[
    TestAccount {
        address: "JLENz97TFT2kYaQmyCSEnBsK8VhaDZNmYATfsLCHyLF6Gzu",
        label: "Account 1",
    },
    TestAccount {
        address: "Gyyh8tbze83BxbZnwDoRs2RxRXhXEpnx8zau4jcaoutmcyY",
        label: "Account 2",
    },
    TestAccount {
        address: "EeDhCnEPX8eitysY6ApQXxMeiZSYMcst3YixR4nzMuARyVy",
        label: "Account 3",
    },
    TestAccount {
        address: "DSk9EUkPLu1n4ssFWwyRKYRJuJ15W2e6AiNw8eaywkv3ap6",
        label: "Account 4",
    },
];
