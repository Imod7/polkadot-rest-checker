...
impl CoverageData {
    ...
    pub fn generate_report(&self) -> String {
        ...
        let block_endpoints = vec!["block", "block-header", "block-extrinsics", "block-extrinsics-raw", "block-extrinsics-idx", "rc-block-extrinsics-raw", "rc-block-extrinsics-idx", "block-para-inclusions", "staking-validators", "rc-staking-validators", "coretime-leases", "coretime-reservations", "coretime-regions"];
